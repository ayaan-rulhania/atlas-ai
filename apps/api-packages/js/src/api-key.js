 ...
 *
 * @param {string} model - The model type ('thor-1.0', 'thor-1.1', 'thor-1.2', or 'antelope-1.1')
...
function generateKey(model, length = 24) {
  const allowedModels = ['thor-1.0', 'thor-1.1', 'thor-1.2', 'antelope-1.1'];
  if (!allowedModels.includes(model)) {
    throw new Error("Model must be 'thor-1.0', 'thor-1.1', 'thor-1.2', or 'antelope-1.1'");
  }
